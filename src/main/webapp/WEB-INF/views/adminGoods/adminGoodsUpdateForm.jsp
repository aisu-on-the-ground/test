											...
											<div id="fileDiv">				
												<c:forEach var="row" items="${list}" varStatus="var">
													<p>
														...
														<input type="hidden" id="IMAGE_CATEGORY"_${var.index }" name="IMAGE_CATEGORY"_${var.index }" value="${row.IMAGE_CATEGORY }">
<%-- 														<input type="text" id="IMAGE_CATEGORY"_${var.index }" name="IMAGE_CATEGORY"_${var.index }" value="${row.IMAGE_CATEGORY }"> --%>
